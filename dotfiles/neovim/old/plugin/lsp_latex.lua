...
NVIM_HOME = "/opt/nvim/share/nvim/runtime/doc/"

local Dictionary_file = {
    ["en-GB"] = {NVIM_HOME .. "spell/dictionary.txt"} -- there is another way to find ~/.config/nvim ?
}
local DisabledRules_file = {
    ["en-GB"] = {NVIM_HOME .. "spell/disable.txt"} -- there is another way to find ~/.config/nvim ?
}
local FalsePositives_file = {
    ["en-GB"] = {NVIM_HOME .. "spell/false.txt"} -- there is another way to find ~/.config/nvim ?
}
